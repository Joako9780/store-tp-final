...
const renderTable = (products) => {
    tableContent = ''; // Reinicia el contenido de la tabla
    products.forEach(product => {
        // Por cada producto, se crea una fila de tabla con sus detalles
        tableContent += `
            <tr>
    ...
    tableBodyElem.innerHTML = tableContent; // Se inserta el contenido acumulado en el cuerpo de la tabla
};

// Se obtiene la lista de productos desde la API
